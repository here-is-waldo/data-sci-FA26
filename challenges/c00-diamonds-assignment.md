...
- There are many data points right at integer carat values (and 1.5
  carat)
- Price generally trends upwards with increased carat
- There are not as many data points above 3 carat
- The distribution of price shifts within the 1-1.5, 1.5-2, and 2-2.5
  carat ranges.
...
- Some of the most expensive diamonds are low-quality cuts but high
  carat
